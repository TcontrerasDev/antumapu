import { A as AstroError, U as UnsupportedImageFormat, x as MissingSharp } from './entrypoint_CQkSUtmK.mjs';
import { b as baseService, d as detector, p as parseQuality } from './generic_D0cFERjl.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_CAXk_Zl4.mjs').then(n => n.i)).default;
  } catch {
